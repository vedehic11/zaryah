        ...
        <div className="max-w-4xl mx-auto bg-white p-8 sm:p-12 rounded-3xl shadow-sm border border-cream-100">
          ...
          <div className="space-y-6 text-neutral-700 leading-relaxed text-sm sm:text-base">
            ...
            <p>
              ...
              <strong className="text-primary-800">www.zaryah.in</strong> ('Website'), including the related 
              mobile site and mobile application (hereinafter referred to as 'Platform').
            </p>

            <p>
              3. The Platform is owned by <strong className="text-primary-800">Vedehi Ajay Choudhary (Proprietor of Zaryah)</strong>, with its registered office at{' '}
            ...
            <p>
              ...
              conditions (&ldquo;Terms of Use&rdquo;) as applicable to the Platform including the applicable policies which 
            ...
            <p>
              5. For the purpose of these Terms of Use, wherever the context so requires &lsquo;you&rsquo;, 'your' or &lsquo;user&rsquo; shall 
              mean any natural or legal person who has agreed to become a user/buyer on the Platform..
            </p>

            <p className="font-semibold text-primary-900 bg-primary-50 p-4 rounded-xl border border-primary-100">
            ...
            <ul className="list-none space-y-4 pl-4 sm:pl-6">
              ...
              <li className="flex items-start">
                <span className="font-semibold text-primary-800 mr-2 flex-shrink-0">6.</span>
                <span>
                  You agree to pay us the charges associated with availing the Services..
                </span>
              </li>
              <li className="flex items-start">
                <span className="font-semibold text-primary-800 mr-2 flex-shrink-0">7.</span>
                <span>
              ...
              <li className="flex items-start">
                <span className="font-semibold text-primary-800 mr-2 flex-shrink-0">8.</span>
                <span>
              ...
              <li className="flex items-start">
                <span className="font-semibold text-primary-800 mr-2 flex-shrink-0">9.</span>
                <span>
            ...
            <p>
              ...
              jurisdiction of the courts in Nashik, Maharashtra.
            </p>
