      ...
      <div className="min-h-screen bg-cream-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto bg-white p-8 sm:p-12 rounded-3xl shadow-sm border border-cream-100">
          ...
          <div className="space-y-6 text-neutral-700 leading-relaxed text-sm sm:text-base">
            ...
            <p>
              The Platform is owned by <strong className="text-primary-800">Vedehi Ajay Choudhary (Proprietor of Zaryah)</strong>, with its registered office at{' '}
            ...
            <p>
              For the purpose of these Terms of Use, wherever the context so requires &lsquo;you&rsquo;, 'your' or &lsquo;user&rsquo; shall 
            ...
            <h2 className="text-xl font-bold text-primary-900 mt-8 mb-4">
